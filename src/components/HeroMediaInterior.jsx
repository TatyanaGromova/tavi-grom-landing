  ...
  return (
    <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(196,181,216,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(196,181,216,0.15) 1px, transparent 1px)',
      ...
      {!compact &&
        miniPreviews.map((card) => (
          <div
            key={card.label}
            className={`absolute ${card.width} ${card.rotate} rounded-lg overflow-hidden border border-white/10 bg-white/[0.04] backdrop-blur-sm`}
      ...
      <div className="absolute top-14 right-4 flex items-center gap-1.5 px-2 py-1 rounded-full bg-white/[0.04] border border-white/10">

...
export default function ServiceCard({ title, description, index = 0 }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-lavender/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
